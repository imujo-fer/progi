...
public class MockExpenseReportItem {
    public static List<ExpenseReportItem> generateMockExpenseReportItems() {
        ...
        items.add(new ExpenseReportItem(1, null, null, null, "Taxi", Currency.EUR, 50.0, 50.0));
        items.add(new ExpenseReportItem(1, null, null, null, "Hotel", Currency.GBP, 54.0, 50.0));
        return items;
    }
}
