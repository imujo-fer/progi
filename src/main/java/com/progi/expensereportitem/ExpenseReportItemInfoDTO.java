...
public class ExpenseReportItemInfoDTO {
    ...
    public ExpenseReportItemInfoDTO(Integer id, Integer receiptId, ExpenseSubcategoryDTO expenseSubcategory, String description, Currency currency, Double currencyValue, Double eurValue) {
        this.id = id;
